...
int main(int argc, char *args[])
{
    ...
    if (setting == 1)
    {
        ...
        while (!quit)
        {
            ...
            if ((300 - (SDL_GetTicks() / 1000)) <= 5 || dot.lives <= 0 || dot2.lives <= 0)
                quit = true;
            while (SDL_PollEvent(&e) != 0)
            {
                // User requests quit
                ...
                else if (dot.mPosX >= 1 && dot.mPosX <= 66 && dot.mPosY >= 470 && dot.mPosY <= 536 && e.type == SDL_KEYDOWN && e.key.keysym.sym == SDLK_e)
                {
                    ...
                    while (!quit10)
                    {
                        ...
                        if (dot.cpoint1 >= 6000 || dot2.cpoint1 >= 6000 || (300 - (SDL_GetTicks() / 1000)) <= 5 || dot.lives <= 0 || dot2.lives <= 0)
                        {
                            quit10 = true;
                            quit = true;
                        }
                ...
                else if (dot.mPosX >= 1 && dot.mPosX <= 66 && dot.mPosY >= 140 && dot.mPosY <= 190 && e.type == SDL_KEYDOWN && e.key.keysym.sym == SDLK_e)
                {
                    ...
                    while (!quit9)
                    {
                        ...
                        if (dot.cpoint1 >= 6000 || dot2.cpoint1 >= 6000 || (300 - (SDL_GetTicks() / 1000)) <= 5)
                        {
                            quit9 = true;
                            quit = true;
                        }
