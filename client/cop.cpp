...
//                SDL_RenderPresent( gRenderer );
            ...
            data += to_string(dot.cpoint1); data += "_";
                ...
                dot2.cpoint1=op5.s;dot2.lives=op5.l;
                 if((300-(SDL_GetTicks()/1000)) <= 5 && dot.cpoint1 > dot2.cpoint1)
                {
                    ggamewon1texture.render(0,0);
                    SDL_RenderPresent( gRenderer );SDL_Delay(1000);
                }
            ...
            data += to_string(dot.cpoint1);
                ...
                if(  (300-(SDL_GetTicks()/1000)) <= 5 || dot.lives<=0 || dot2.lives<=0) quit=true;
				while( SDL_PollEvent( &e ) != 0 )
				{
					//User requests quit
					if( e.type == SDL_QUIT )
...
//                                }
                        ...
                        data += to_string(dot.cpoint1);
                            ...
                            if(dot.cpoint1 >=6000 || dot2.cpoint1>=6000 || (300-(SDL_GetTicks()/1000)) <= 5 || dot.lives<=0 || dot2.lives<=0) {quit10=true;quit=true;}
                            }}
...
//                                }
                        ...
                        data += to_string(dot.cpoint1);
                            ...
                            if(dot.cpoint1 >=6000 || dot2.cpoint1>=6000 || (300-(SDL_GetTicks()/1000)) <= 5 ) {quit9=true;quit=true;}
...
// 1096,154,1199,223
                             else if ( dot.mPosX>=1096 && dot.mPosX<=1199 && dot.mPosY>=154 && dot.mPosY<=223 && e.type == SDL_KEYDOWN && e.key.keysym.sym == SDLK_e )
                    {
                      ...
                      data += to_string(dot.cpoint1);
                          ...
                          if(dot.cpoint1 >=6000 || dot2.cpoint1>=6000 || (300-(SDL_GetTicks()/1000)) <= 5 ) {quit8=true;quit=true;}
