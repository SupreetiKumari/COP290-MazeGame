...
// kara
vector<pair<SDL_Rect,int>> set1Point1s(){
    vector<pair<SDL_Rect,int>> points;
    points.push_back(createwall2(985,285,50,80,6000));//Aravali:coin.png:hint16
    return points;
}
//jwala
vector<pair<SDL_Rect,int>> set1Point2s(){
    vector<pair<SDL_Rect,int>> points;
    points.push_back(createwall2(482,439,280,60,0));//Aravali:coin.png:hint16
    return points;
}
//dogra
vector<pair<SDL_Rect,int>> set1Point3s(){
    vector<pair<SDL_Rect,int>> points;
    points.push_back(createwall2(355,199,50,40,0));//Aravali:coin.png:hint16
    return points;
}
vector<pair<SDL_Rect,int>> set2Point1s(){
    vector<pair<SDL_Rect,int>> points;
    points.push_back(createwall2(985,285,50,80,0));//Aravali:coin.png:hint16
    return points;
}
//jwala
vector<pair<SDL_Rect,int>> set2Point2s(){
    vector<pair<SDL_Rect,int>> points;
    points.push_back(createwall2(482,439,280,60,6000));//Aravali:coin.png:hint16
    return points;
}
//dogra
vector<pair<SDL_Rect,int>> set2Point3s(){
    vector<pair<SDL_Rect,int>> points;
    points.push_back(createwall2(355,199,50,40,0));//Aravali:coin.png:hint16
    return points;
}
vector<pair<SDL_Rect,int>> set3Point1s(){
    vector<pair<SDL_Rect,int>> points;
    points.push_back(createwall2(985,285,50,80,0));//Aravali:coin.png:hint16
    return points;
}
//jwala
vector<pair<SDL_Rect,int>> set3Point2s(){
    vector<pair<SDL_Rect,int>> points;
    points.push_back(createwall2(482,439,280,60,0));//Aravali:coin.png:hint16
    return points;
}
//dogra
vector<pair<SDL_Rect,int>> set3Point3s(){
    vector<pair<SDL_Rect,int>> points;
    points.push_back(createwall2(355,199,50,40,6000));//Aravali:coin.png:hint16
    return points;
}
